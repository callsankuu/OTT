...
import 'ott bottom navigation.dart';
import 'ott finalpage.dart';
         ...
         child: SingleChildScrollView(
          child: Column(
            children: [
              Padding(
                ...
                Stack(
                  children: [
                    ...
                    AssetImage("assets/newimage.png")
                ...
                children: [
                  Row(
                    children: [
                      ...
                      Text("Full Name", style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: Colors.white,),),
                      Padding(
                        padding: const EdgeInsets.only(left:60.0),
                        child: Text("Shiva Sankar", style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: Colors.white,),),
                      ),
                    ],
                  ),
                ],
                ...
                children: [
                  Row(
                    children: [
                      ...
                      Text("Phone no", style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: Colors.white,),),
                      Padding(
                        padding: const EdgeInsets.only(left:60.0),
                        child: Text("7464688968", style: TextStyle(fontSize: 20,color: Colors.white,fontWeight: FontWeight.bold),),
                      ),
                    ],
                  ),
                ],
              ...
              Text("By sharing this information,you agree \nto the Amazon Prime Privacy Policy",
